...
\renewcommand{\stampversion}{\detokenize{7314cff-wip}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{booktabs}
...
\title{Robustness of the Linearity Assumption in Random-Slopes MMRM for Alzheimer's Disease Trials}
...
with traditional cognitive scales such as the ADAS-Cog\textsuperscript{\citeproc{ref-cedarbaum2013rationale}{1},\citeproc{ref-coley2011suitability}{2}}. Annual
CDR-SB progression rates in placebo arms of recent trials
are approximately 1.3 to 1.7 points per year for
participants with baseline CDR global scores of 0.5 to 1.0\textsuperscript{\citeproc{ref-cedarbaum2013rationale}{1},\citeproc{ref-hartz2025clinical}{3}}.
...
versus 1.66 in placebo\textsuperscript{\citeproc{ref-vandyck2023lecanemab}{4}}. The
TRAILBLAZER-ALZ 2 trial of donanemab demonstrated a similar
magnitude of slowing on CDR-SB in participants with
low/medium tau burden\textsuperscript{\citeproc{ref-sims2023donanemab}{5}}. In both trials,
...
\item
  ...
  response evolves over time\textsuperscript{\citeproc{ref-mallinckrodt2008recommendations}{6}}.
\item
...
mechanism is expected to produce a constant rate of slowing\textsuperscript{\citeproc{ref-fda2018guidance}{7}}. The European Medicines Agency's guideline
...
verified\textsuperscript{\citeproc{ref-ema2018guideline}{8}}. The ICH E9(R1) addendum on
estimands provides the formal framework for distinguishing
these two targets of estimation, emphasizing that the choice
of estimand should precede the choice of statistical model\textsuperscript{\citeproc{ref-ich2019e9r1}{9}}.
...
\item
  ...
  (documented by\textsuperscript{\citeproc{ref-jamalian2023modeling}{10}} using nonlinear
...
the random-slopes model can tolerate.\textsuperscript{\citeproc{ref-chen2018simulation}{11}}
...
\tightlist
\item
  A \textbf{random-slopes MMRM} that fits treatment-by-time as
...
Following Morris, White, and Crowther\textsuperscript{\citeproc{ref-morris2019using}{12}}, the
...
\textbf{Random-slopes model.} We fit a linear mixed-effects model
(via \texttt{nlme::lme}) with fixed effects for treatment, time
...
\textbf{Categorical-time MMRM.} We fit the standard marginal
MMRM used in clinical trials (via \texttt{nlme::gls}) with fixed
...
across visits). This is the model recommended by\textsuperscript{\citeproc{ref-mallinckrodt2008recommendations}{6}} and implemented in the
\texttt{mmrm} R package\textsuperscript{\citeproc{ref-sabanesbove2024mmrm}{13}}. The treatment
...
\caption{Treatment effect trajectories under different shape parameters. All curves reach the same total effect at month 18.}
\end{figure}
...
models are more efficient than nonparametric alternatives\textsuperscript{\citeproc{ref-mallinckrodt2008recommendations}{6},\citeproc{ref-chen2018simulation}{11}}.
...
approximately linear'\textsuperscript{\citeproc{ref-fda2018guidance}{7}}. The EMA guideline
similarly conditions slope-based claims on verifiable
linearity\textsuperscript{\citeproc{ref-ema2018guideline}{8}}. The ICH E9(R1) estimand
framework reinforces that the estimand (slope vs.
final-visit) should be chosen on scientific grounds before
the statistical model is specified\textsuperscript{\citeproc{ref-ich2019e9r1}{9}}.

The results from recent Phase 3 trials are instructive.
Visual inspection of CDR-SB trajectories in CLARITY-AD\textsuperscript{\citeproc{ref-vandyck2023lecanemab}{4}} and TRAILBLAZER-ALZ 2\textsuperscript{\citeproc{ref-sims2023donanemab}{5}} suggests that the treatment effect
...
clearance. The proportional MMRM approach of\textsuperscript{\citeproc{ref-wang2022proportional}{14}} offers an intermediate option that
...
\item
  ...
  proportional MMRM\textsuperscript{\citeproc{ref-wang2022proportional}{14}} and constrained
...
\item
  ...
  approach of\textsuperscript{\citeproc{ref-novic2024nonlinear}{15}}.
\item
...
\item
  ...
  package infrastructure\textsuperscript{\citeproc{ref-sabanesbove2024mmrm}{13}}.
\item
  ...
  \(\kappa\) for different endpoints and disease stages\textsuperscript{\citeproc{ref-jamalian2023modeling}{10}}.
\end{enumerate}
...
standards proposed by Morris, White, and Crowther\textsuperscript{\citeproc{ref-morris2019using}{12}}. The full audit is recorded at
...
\item
  ...
  (1000).
\item
  \texttt{set.seed()} is called inside the worker function rather
...
\CSLLeftMargin{14. }%
\CSLRightInline{Wang J, Logovinsky V, Bhatt DL, Tian Y, Bhore R, Sperling RA. Proportional constrained longitudinal data analysis models for clinical trials in sporadic {Alzheimer's} disease. \emph{Alzheimer's \& Dementia: Translational Research \& Clinical Interventions}. 2022;8(1):e12286. doi:\href{https://doi.org/10.1002/trc2.12286}{10.1002/trc2.12286}}

\bibitem[\citeproctext]{ref-novic2024nonlinear}
\CSLLeftMargin{15. }%
\CSLRightInline{Novic A, Engel B, Scheltens P, Barkhof F, Berkhof J. Novel non-linear models for clinical trial analysis with longitudinal data: A tutorial using {SAS} for both frequentist and {Bayesian} methods. \emph{Pharmaceutical Statistics}. Published online 2024. doi:\href{https://doi.org/10.1002/pst.2394}{10.1002/pst.2394}}
